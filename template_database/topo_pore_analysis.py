...
topos = ["acs",  "act" , "apo",  "bcu",  "ceq" , "csq",  "cut",  "dag",  "ddi" , "edq",  "eea",  "fcu",  "flu",  "fog", 
		"fsc",  "ftw" , "hwx",  "ibe",  "kkm" , "lil",  "lim",  "lnj",  "lvtb", "mcn",  "mrc",  "nbob," "pcu",  "phx", 
		"pts",  "pyr" , "qza",  "reo",  "rhrb", "rtl",  "scu",  "sit",  "sqca", "ssa",  "stp",  "stu",  "stx",  "sty", 
		"sur",  "svnd", "tfk",  "the",  "tru" , "tty",  "ucp",  "xll"] 
